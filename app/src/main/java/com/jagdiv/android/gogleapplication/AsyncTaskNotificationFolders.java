...
public class AsyncTaskNotificationFolders extends AsyncTask<Pair<Context, String>, Void, String> {
...
protected String doInBackground(Pair<Context, String>... params) {
        ...
        HttpPost httpPost = new HttpPost("https://ggledrvsrvcaccnt.appspot.com/drivesrvcaccnt");
     //   HttpPost httpPost = new HttpPost("http://10.0.2.2:8080/puttoken");
        try {
        // Add name data to request
        List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
        nameValuePairs.add(new BasicNameValuePair("forfutureputting", "enjoy"));
