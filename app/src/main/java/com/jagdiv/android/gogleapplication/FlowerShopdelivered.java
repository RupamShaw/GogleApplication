...
public class FlowerShopdelivered {
    ...
    public static void main(String[] args) {
        ...
        new FlowerShopdelivered().new DataStructure().createShop(selectedBunch);
...
//        executor.submit(new FlowerShopdelivered().new Order("T58", 13));
    ...
    private class Order implements Runnable {
        ...
        void process() {
            ...
            Map<Integer, Integer> result = new FlowerShopdelivered().new DataStructure().pickBundle(this.code, this.qty);
            printOrder(result);
        }
...
*/
        ...
        private void createShop(Map<FlowerName, ArrayList<FlowerBundle>> selectedBunch) {
            ...
            flowerType.add((FlowerName) new FlowerShopdelivered().new FlowerName("R12", "Roses"));
            flowerType.add((FlowerName) new FlowerShopdelivered().new FlowerName("L09", "Lilies"));
            flowerType.add((FlowerName) new FlowerShopdelivered().new FlowerName("T58", "Tulips"));

            ArrayList<FlowerBundle> roseBundleType = new ArrayList<FlowerBundle>(2);
            roseBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(5, 6.99f));
            roseBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(10, 12.99f));

            selectedBunch.put(flowerType.get(0), roseBundleType);

            ArrayList<FlowerBundle> lillyBundleType = new ArrayList<FlowerBundle>(3);
            lillyBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(3, 9.95f));
            lillyBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(6, 16.95f));
            lillyBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(9, 24.95f));

            selectedBunch.put(flowerType.get(1), lillyBundleType);

            ArrayList<FlowerBundle> tulipBundleType = new ArrayList<FlowerBundle>(3);
            tulipBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(3, 5.95f));
            tulipBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(5, 9.95f));
            tulipBundleType.add((FlowerBundle) new FlowerShopdelivered().new FlowerBundle(9, 16.99f));
